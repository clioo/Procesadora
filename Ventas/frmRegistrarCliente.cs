...
namespace Procesadora
{
    public partial class frmRegistrarCliente : Form
    {
        ...
        private bool buscarRFC(string RFC)
        {
            ...
            dt = conexion.Select("RFC, ID_Cliente", "Clientes", "rfc = " + "'" + RFC + "'");
            if (dt.Rows.Count == 0)
            {
        ...
        private void Registrar_Click(object sender, EventArgs e)
        {
            ...
            if (validar())
            {
                try
                {
                    bool b = conexion.Insert("Clientes", "email, id_ciudad,cp,colonia,calle,numeroExt,numeroInt,limitecredito,rfc,nombre",
                    ...
                    //ingresar numeros de telefono del Cliente
                    if (b)
                    {
                        Boolean Correcto = true;
                        foreach (string numero in listaNumeros)
                        {
                            if (!conexion.Insert("TelefonosClientes", "ID_cliente,telefono",
                                comillas(id_rfc) + "," + comillas(numero))) Correcto = false;
                        }
                        if (Correcto)
                        {
                            limpiar();
                        ...
                        else MessageBox.Show("Error Telefono");
                    }
                    else
                    {
        ...
        private void frmRegistrarCliente_Load(object sender, EventArgs e)
        {
            ...
            cbCiudad.DataSource = conexion.Select("nombre,id_ciudad", "ciudades");//Codigo de conexion
        }
        ...
        {
            frmGenerarFactura gen = new frmGenerarFactura();
            gen.Show();
            this.Close();
        }
        ...
        {
            frmModificarCliente modc = new frmModificarCliente();
            modc.Show();
            this.Close();
        }
    }
